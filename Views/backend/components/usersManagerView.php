...
<div class="small-12 grid-x">
    ...
    foreach ($data as $user) {
        print_r(
'<div class="user grid-x medium-6">
            ...
            <div class="user__controls small-12">
                <a href="index.php?action=editeruser&id='. $user['id'].'" class="btn admin-crud__btn admin-crud__btn--editer">Editer</a>
                <a href="index.php?action=supprimeruser&id='. $user['id'].'" class="btn admin-crud__btn admin-crud__btn--supprimer">Supprimer</a>
            </div>
        </div>');
    }
    ?>
